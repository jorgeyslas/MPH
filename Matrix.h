...
/*  Matrix library
    ...
    Matrix<Type,dimension> myMatrix(dim1,dim2,...dimn). where n=dimension
    For instance Matrix<doubles,2> myMatrix(n,m) is a matrix in R^2 of size nxm.  Matrix<doubles,1> myMatrix2(n) is a vector in R of size n.
 
    myMatrix + c, with c constant, adds c to all elements of my Matrix
    Note:  c + myMatrix does not work
    
    myMatrix*c, with c constant, multyplies all elements of my Matrix by c
    Note:  c * myMatrix does not work
    
    myMatrix/c, with c constant, divides all elements of my Matrix by c
    
    myMatrix.dim1() returns dim1 and so on
*/
